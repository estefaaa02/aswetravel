...
<body>
    ...
    <!-- datos usuario sin registro-->

    <section class="blog_area single-post-area p_120">
        <form id="world" name="world" method="post" action="realizarCompraAsesor.php">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-0">
                            <div class="comment-form">
                                ...
                                <div class="switch-wrap d-flex justify-content-between">
                                    <center>
                                        <div class="form-group col-lg-7 col-md-0 name">
                                            <section class="sample-text-area">
                                    ...
                                    <div class="form-group col-lg-10 col-md-0 name">
                                        <select class="custom-select form-control" name="cargo" id="cargo">
                                            <?php
            ...
            <!-- Fin datos usuario sin registro -->
                            ...
                            <div class="comment-form">
                                ...
                                <center>
                                    ...
                                    <?php
                                        ...
                                        ?>
                                            ...
                                            <p> <?php echo $asiento->getNom_asiento(); ?> </p>
                                        <?php
                                            ...
                                            ?>
                                                            <div class="primary-checkbox">
                                                                <input type="checkbox" name="asiento[]" value=<?php echo $asiento->getCod_asiento(); ?>
                                ...
                                <div class="switch-wrap d-flex justify-content-between">
                                    <div class="button-group-area mt-10">
                                        <a href=<?php $_SERVER["DOCUMENT_ROOT"]."/index.php"?> class="genric-btn warning-border circle">Regresar</a>
                                    </div>
                                    <div class="button-group-area mt-10">
