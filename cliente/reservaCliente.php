...
<body>
    ...
    <section class="blog_area single-post-area p_120">
        <form method="post" action="realizarReservaCliente.php" class="needs-validation" novalidate>
        <?php
                          
            if(isset($_SESSION["asientos"])){
                echo " <div class='alert alert-danger alert-dismissible fade show'>
                <center>  <button type='button' class='close' data-dismiss='alert'>&times;</button>
                <strong>ERROR! </strong> Debe escoger asiento. </center>
                </div>";
                            ...
                            <div class="comment-form">
                                ...
                                <div class="switch-wrap d-flex justify-content-between">
                                    ...
                                    <div class="form-group col-lg-4 col-md-30 name">
                                        ...
                                        <section class="sample-text-area">
                                            <p><?php echo $vuelo->getFecha_llegada(); ?></p>
                                        </section>
                                    </div>
                                </div>
                                ...
                                <div class="switch-wrap d-flex justify-content-between">
                                    <div class="button-group-area mt-10">
                                        <a class="genric-btn warning-border circle" href="../index.php" ?> >Regresar</a>
                                    </div>
                                    <div class="button-group-area mt-10">
                                            <button type="submit" name='envio' class="genric-btn danger circle" aria-label> Registrar
                                            </button>
                                        </div>
                                </div>
                            </div>
